...
def ExtractFeaturesForDir(args, dir, prefix):
    ...
    # outputFileName = "/Users/unaissiddiqui/Desktop/Fyp/code2vec/data/git-repos-32/feature_extractor/" + prefix + dir.split('/')[-1] + ".gz"
    outputFileName = args.outdir + "/feature_extractor/" + prefix + dir.split('/')[-1] + ".gz"
    sys.stderr.write("DIR : " + dir.split('/')[-1] + "\n")
    sys.stderr.write("TMP : " + TMP_DIR + "\n")
...
def ExtractFeaturesForDirsList(args, dirs):
    ...
    sys.stderr.write("TMPDL : " + TMP_DIR + "\n")
    # DDIR ="/Users/unaissiddiqui/Desktop/Fyp/code2vec/code2vec_c/"
...
if __name__ == '__main__':
    ...
    parser.add_argument("-trainf", "--train-flag", dest="train_flag", required=False, default=1)
