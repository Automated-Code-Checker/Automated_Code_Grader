...
def generate_cmd(args):
    ...
    command = ['python', '/Users/unaissiddiqui/Desktop/Fyp/Automated_Code_Grader/cparser.py', "--clang-path", args.clang_path, "--max-leaves", args.max_leaves, "--no-hash-paths", "TRUE"]
...
class CExtractor:
    ...
    def extract_paths(self, path):
        ...
        for i, line in enumerate(output):
            ...
            for context in contexts[:self.args.MAX_CONTEXTS]:
            ...
            space_padding = ' ' * (self.args.MAX_CONTEXTS - len(contexts))
