...
. "/Users/unaissiddiqui/Desktop/Fyp/Automated_Code_Grader/configure.sh"

MODEL='/Users/unaissiddiqui/Desktop/Fyp/Automated_Code_Grader/Models/6481076_model.pth'
MAX_CONTEXTS=200

# export CLANG_PATH=
export CLANG_PATH="$CLANG_PATH:/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/libclang.dylib"
export PYTHONPATH="$PYTHONPATH:/Users/unaissiddiqui/Desktop/Fyp/Automated_Code_Grader"

${PYTHON} invoke_interactive.py --load ${MODEL} 